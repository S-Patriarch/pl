...
//
   void set_brackets(std::string bracketLeft_,std::string bracketRigth_)
   {
...
//
   void set_color(pl::Color::color color_,std::string colorText="tr")
   {
...
//
   void set_style(std::string style_,std::string percent_)
   {
      m_style=style_;
      m_percent=percent_;
   }
...
//
   void set_bar_width(unsigned short width_)
   {
      m_barWidth=width_;
   }
//------------------------------------------------------------------------------
